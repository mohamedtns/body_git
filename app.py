            ...
            while not self.stopped:
                ...
                if results.pose_landmarks:
                    ...
                    if is_predicting and trained_model:
                        columns = [f'{i}_{axis}' for i in range(33) for axis in ['x', 'y', 'z']]
...
def download_data():
    ...
    file_path = 'body_poses.csv'
    df.to_csv(file_path, index=False)

    return send_file(file_path, mimetype='text/csv', download_name='body_poses.csv', as_attachment=True)
